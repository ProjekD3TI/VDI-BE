    ...
    */
    ...
    'environments' => [
        'production' => [
            'supervisor-1' => [
                'connection' => 'redis',
                'queue' => ['default', 'vm-provisioning'], // Anda bisa membuat antrean khusus
                'balance' => 'auto',
                'autoScalingStrategy' => 'time',
                'maxProcesses' => 2, // Batasi proses concurrent agar server/hypervisor tidak kewalahan
                'maxTime' => 0,
                'maxJobs' => 0,
                'memory' => 256,
                'tries' => 1,
